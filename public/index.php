...
<div class="container" data-aos="fade-up"
	...
	<div class="introduction">
		<h1 style="font-size: 300%; color: green; background-color: black; text-align: center;border: solid 1px;border-radius:10% 100%;width: 100%;margin-left: 10%;margin-right: 10%;">Welcome to my website</h1> 
	</div>
</div>
